...
ggsave("plot_HealthInfoEnv_detailed.pdf", width = 15, height = 10, dpi = 3000)
...
ggsave("plot_Interventions_I_detailed.pdf", width = 15, height = 10, dpi = 3000)
...
ggsave("plot_Interventions_S_detailed.pdf", width = 15, height = 10, dpi = 3000)
...
ggplot(Data_threat_actors, aes(x=Q,y=Percentage, fill=Response)) + 
  ...
  theme(legend.position = "bottom",
        ...
        plot.margin = margin(20, 10, 10, 10))+
  geom_text(aes(label = sprintf("%.1f%%", Percentage)), 
            position = position_stack(vjust = 0.5), size = 3,check_overlap = TRUE)+
  guides(fill = guide_legend(nrow = 1,reverse=TRUE))+
  ggtitle("To what extent does each of the following represent
          a threat to the information environment?")

ggsave("plot_Threats_Actors_detailed.pdf", width = 15, height = 10, dpi = 3000)
...
# Data_threat_plat$Response_numeric <- recode(Data_threat_plat$Response,
#                                               "The biggest" = 7,
#                                               "Very big" = 6,
#                                               "Big" = 5,
#                                               "Moderate" = 4,
...
ggsave("plot_Threats_Plat_detailed_detailed.pdf", width = 15, height = 10, dpi = 3000)
...
past = ggplot(Data_past, aes(x=Q, y=Percentage,fill=Response)) + 
  ...
  the info. env.?")
past
ggsave("plot_past_detailed.pdf", width = 15, height = 10, dpi = 3000)
...
ggsave("plot_future_detailed.pdf", width = 15, height = 10, dpi = 3000)
...
ggsave("plot_concernsAI_detailed.pdf", width = 15, height = 10, dpi = 3000)
...
ggsave("plot_hopesAI_detailed.pdf", width = 15, height = 10, dpi = 3000)
...
ggsave("plot_future_field_detailed.pdf", width = 15, height = 10, dpi = 3000)
